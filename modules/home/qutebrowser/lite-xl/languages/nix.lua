...
-- Lemon modified to match the syntax highlighting of https://github.com/nix-community/vscode-nix-ide
-- Thx Lemon
-- https://github.com/PassiveLemon/lemonix/blob/master/users/lemon/common/home/.config/lite-xl/plugins/languages/language_nix.lua
